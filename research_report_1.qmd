...
```{r weight-decay-function_[7], echo=TRUE, message=TRUE, warning=FALSE}
#| code-fold: TRUE
...
```{r weight-decay-plot_[8], echo=FALSE, message=TRUE, warning=FALSE}
...
[Main code and output for sample Gradient Descent with Convergence in OLS]()
