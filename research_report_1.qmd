...
\begin{center}
\textit{\large Main code and output for sample Gradient Descent with Convergence in OLS}
\end{center}
...
\begin{center}
\textit{\large Main code and output for sample Weight Decay and Gradient Descent with Convergence in OLS}
\end{center}
...
\begin{center}
\textit{\large Bias and Variance under a Linear DGP with Monte Carlo Simulations}
\end{center}
...
# Citations
$^1$ [MSE Wikipedia](https://en.wikipedia.org/wiki/Mean_squared_error)

$^2$ [Gauss-Markov Theorem Wikipedia](https://en.wikipedia.org/wiki/Gauss%E2%80%93Markov_theorem)

$^3$ [ISL Credit Card Data](https://rdrr.io/cran/ISLR/man/Credit.html)

$^4$ [Gradient Wikipedia](https://en.wikipedia.org/wiki/Gradient)